...
const PROJECTS = [
    {
        id: 2,
        title: 'Racing Game',
        description: 'An interactive 3D racing game built with Three.js and React Three Fiber.',
        image: '/images/racing-game.png',
    },
    {
        id: 1,
        title: 'Kanban',
        description: 'A simple Kanban board. Add tasks and drag them between columns.',
        image: '/images/kanban.png',
    },
    {
        id: 5,
        title: 'Multiplayer Game',
        description: 'Realtime multiplayer game prototype powered by Laravel Reverb.',
        ...
        <>
                ...
                >
                    <div className="relative max-h-[90vh] max-w-4xl" onClick={(e) => e.stopPropagation()}>
                        <button
                            type="button"
                            onClick={() => setLightbox(null)}
                            className="absolute -top-2 -right-2 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-neutral-800 text-neutral-300 hover:bg-neutral-700 hover:text-white"
                            aria-label="Close"
                        >
                            ×
                        </button>
                        <img src={lightbox.src} alt={lightbox.alt} className="max-h-[85vh] w-auto rounded-lg object-contain" />
                        {lightbox.description && <p className="mt-3 text-center text-sm text-neutral-300">{lightbox.description}</p>}
                    </div>
                </div>
            )}
            <div className="min-h-screen bg-[#FDFDFC] dark:bg-[#0a0a0a]">
                <main className="flex flex-col">
                    {/* Hero Section */}
                    <section className="relative flex min-h-[70vh] flex-col items-center justify-center gap-8 overflow-hidden bg-[#0a0a0a] px-6 py-20 lg:py-32">
                            ...
                            <div className="flex flex-col items-center gap-8 lg:flex-row lg:items-center lg:justify-center lg:gap-10">
                                <ScrollReveal direction="right" delay={0.2}>
                                    <div className="flex flex-col items-center gap-4">
                                        ...
                                        <SkillPills pillClassName="text-neutral-400 hover:text-neutral-300 hover:scale-105" items={CONTACT_LINKS} />
                                    </div>
                                </ScrollReveal>
                                <ScrollReveal direction="left" delay={0.3}>
                                    <div className="max-w-xl space-y-4 text-center text-lg leading-relaxed text-neutral-300 lg:text-left">
                                        ...
                                        <p>
                                            Welcome to my site! I&apos;m a Laravel developer who likes writing clean, sensible code—or watching Cursor
                                            knock it out while I pretend I&apos;m supervising.
                                        </p>
                                        <p>
                                            I use this site to share projects I&apos;ve built for fun and learning. Feel free to try them out below!
                                        </p>
                                    </div>
                                </ScrollReveal>
                            </div>
                    ...
                    {/* Skills & Tools */}
                    <section id="skills" className="relative bg-[#f8f8f6] px-6 py-16 lg:py-24">
                        ...
                        <div className="relative z-10 mx-auto max-w-6xl">
                            ...
                            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                                {visibleProjects.map((project, index) => (
                                    <ScrollReveal key={project.id} direction="up" delay={0.2 + index * 0.1} className="h-full">
                                        <div className="relative h-full rounded-2xl border border-neutral-300 p-2 transition-all hover:scale-[1.03] md:rounded-3xl md:p-3">
                                            ...
                                            >
                                                <div className="relative aspect-video w-full overflow-hidden bg-neutral-800">
                                                    ...
                                                    />
                                                    <span className="absolute inset-0 flex hidden items-center justify-center text-sm text-neutral-500">
                                                        Image
                                                    </span>
                                                </div>
                                                <div className="p-6">
                                                    ...
                                                    {[
                                                        {
                                                            ...
                                                            title: 'Racing Game',
                                                            sentence: 'An interactive 3D racing game built with Three.js and React Three Fiber.',
                                                            tools: [
                                                                { name: 'React', logo: <ReactLogo /> },
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            alt: 'Hockey',
                                                            description: 'Hockey. A custom built site for a hockey agency. Laravel, Tailwind.',
                                                            title: 'Hockey',
                                                            sentence: 'A custom built site for a hockey agency.',
                                                            tools: [
                                                                { name: 'Laravel', logo: <LaravelLogo /> },
                                                                { name: 'Tailwind', logo: <TailwindLogo /> },
                                                            ],
                                                    ...
                                                    {[
                                                        {
                                                            ...
                                                            alt: 'Buffered Index',
                                                            description: 'Buffered Index. A splash page landing page. Laravel, Tailwind.',
                                                            title: (
                                                            ...
                                                            sentence: 'Just another splash page landing page.',
                                                            tools: [
                                                                { name: 'Laravel', logo: <LaravelLogo /> },
                                                                { name: 'Tailwind', logo: <TailwindLogo /> },
                                                            ],
                                                        },
                                                        {
                                                            ...
                                                            sentence: 'A marketing site for financial professionals built with Laravel and Tailwind.',
                                                            tools: [
                                                                { name: 'Laravel', logo: <LaravelLogo /> },
                                                                { name: 'Tailwind', logo: <TailwindLogo /> },
                                                            ],
                                                        },
                                                        {
                                                            ...
                                                            sentence: 'A marketing tool for financial advisors built with Vue and Tailwind.',
                                                            tools: [
                                                                { name: 'Vue', logo: <VueLogo /> },
                                                                { name: 'Tailwind', logo: <TailwindLogo /> },
                                                            ],
                                                ...
                                                <div className="grid grid-cols-1 gap-6 md:grid-cols-[1fr_auto] md:gap-8">
                                                    <div>
                                                        ...
                                                        <p className="mt-2 text-xs font-normal text-neutral-600 md:text-sm">
                                                            The &quot;Color of Money Risk Analysis&quot; was another financial template. It featured a
                                                            13-question dynamic survey with a calculated score at the end.
                                                        </p>
                                                        <p className="mt-4 text-xs font-semibold tracking-wider text-neutral-500 uppercase dark:text-neutral-400">
                                                            Tools used
                                                        </p>
                                                        <SkillPills
                                                            className="mt-1.5"
                                                    ...
                                                    {[
                                                        {
                                                            ...
                                                            alt: 'PageLab',
                                                            description:
                                                                'A page builder where you piece together customizable heroes, content sections, and more to build a site quickly.',
                                                            title: 'PageLab',
                                                            sentence:
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            sentence: 'Another financial advisor template geared towards retirement.',
                                                            tools: [
                                                                { name: 'Laravel', logo: <LaravelLogo /> },
                                                                { name: 'Tailwind', logo: <TailwindLogo /> },
                                                                { name: 'Alpine.js', logo: <AlpineLogo /> },
                    ...
                    <section className="relative overflow-hidden bg-[#1a1a18] px-6 py-16 lg:py-24">
                        ...
                        <ScrollReveal direction="up" delay={0.1}>
                            <div className="relative z-10 mx-auto max-w-3xl text-center">
                                <h2 className="text-3xl font-bold text-white lg:text-4xl">Want to hire me?</h2>
                                <p className="mx-auto mt-4 max-w-xl text-base font-medium text-brand md:text-lg">
                                    I&apos;m open to Laravel and full-stack work—whether that&apos;s a role on your team or help shipping something
                                    new.
                                </p>
